...
#in a survey and not a naturally measured variable. Thus one should for example refrain from intepretations like "a person with 
# satisfaction 8 is twice as happy as one with satisfaction 4." In fact, a multinomial probit model would also be a good choice to 
# examine the influence of certain regressors on the self-reported happiness.
...
#satisfaction seems to be increasing in empPopRatio.
